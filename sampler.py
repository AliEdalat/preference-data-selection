...
def Sampling(name, ds, strategy, part, Num):
    ...
    if strategy == 'orth':
        ...
        f_reward = open(f'./Less-is-More/metric/hh_orthogonal_fused_rewards.jsonl', 'r')
    ...
    if strategy == 'att':
        ...
        rewards_real = []
        # f_reward = open(f'./Less-is-More/metric/{name}_rm_scores.jsonl', 'r')
        f_reward = open(f'./Less-is-More/metric/hh_attention_fused_rewards.jsonl', 'r')
    ...
    if strategy == 'in_reward_margin':
        ...
        with open(f'./Less-is-More/metric/dpo_2k_hh_ppl.jsonl', 'r') as file:
            for line in file:
...
if __name__ == '__main__':
    ...
    output_path = '/home/jovyan/llm_project/datasets/hh_orth_2k.jsonl'
    ...
    # # Save sample to JSONL
    # output_path = '/home/jovyan/llm_project/datasets/uf_random_sample2.jsonl'
    # ds_tr.to_json(output_path, orient='records', lines=True)
