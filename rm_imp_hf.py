...
def parse_args():
    ...
    parser.add_argument("--save_path", type=str, default='./Less-is-More/metric/uf_imp_rm_scores.jsonl')
    parser.add_argument("--model_name", type=str, default='./models/model_uf_random')
...
def main():
    ...
    for i in tqdm(range(12701, len(ds))):
        data_i = ds[i]
