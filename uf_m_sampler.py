...
def Sampling_ensemble(name, ds, strategy, part, Num):
    ...
    # llm_project/Less-is-More/metric/llama_uf_rm_scores.jsonl
...
if __name__ == '__main__':
    ...
    # ds_tr = Sampling_ensemble('hh', ds, 'add', 'top', 2000)
    # print(ds_tr)

    # # Save sample to JSONL
    # output_path = '/home/jovyan/llm_project/datasets/hh_BeeS_sample_P_add.jsonl'
    ...
    ds_tr = Sampling_ensemble('hh', ds, 'mul', 'top', 2000)
    print(ds_tr)

    # Save sample to JSONL
    output_path = '/home/jovyan/llm_project/datasets/uf_BeeS_sample_P_mul_sft.jsonl'
    ds_tr.to_json(output_path, orient='records', lines=True)
